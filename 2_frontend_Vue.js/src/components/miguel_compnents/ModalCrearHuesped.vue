<template>
  ...
  const crearhuesped = async () => {
    try {
      console.log('Datos del nuevo huésped:', huesped.value); // Verifica los datos
      ...
      console.log('Huésped creado con éxito:', response.data);
      emit('crearHuesped', response.data); // Emite el nuevo huésped al componente padre
      cerrarModal(); // Cierra el modal
    } catch (error) {
      console.error('Error al crear huésped:', error.response?.data || error);
    }
  };
  </script>
