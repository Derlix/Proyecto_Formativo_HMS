    ...
    >
      ...
      <div v-if="currentStep === 1">
        ...
        <div class="flex flex-col items-center">
          <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg w-full max-w-7xl p-6">
            <!-- Aquí aumenté el tamaño del modal -->

            <!-- Input para buscar pasajero -->
            ...
            <!-- Tabla de resultados -->
            <div
              class="overflow-x-auto bg-gray-50 dark:bg-gray-800 rounded-lg shadow-md p-4 max-h-[400px]"
            >
              <!-- Ajusté la altura máxima a 400px -->
              <table class="min-w-full bg-white dark:bg-gray-700 border-gray-300">
                <thead>
                  <tr class="bg-gray-200 dark:bg-gray-600 text-gray-700 dark:text-gray-200">
                    <th class="px-4 py-2 w-1/4">Nombre Completo</th>
                    <th class="px-4 py-2 w-1/5">Documento</th>
                    <th class="px-4 py-2 w-1/5">Fecha Reserva</th>
                    <th class="px-4 py-2 w-1/5">Habitación</th>
                  </tr>
                </thead>
                <tbody>
                  <tr
                  ...
                  >
                    <td class="border px-4 py-2 dark:text-white truncate w-1/4">
                      {{ reserva.huesped.nombre_completo }}
                    </td>
                    <td class="border px-4 py-2 dark:text-white truncate w-1/5">
                      {{ reserva.huesped.numero_documento }}
                    </td>
                    <td class="border px-4 py-2 dark:text-white w-1/5">
